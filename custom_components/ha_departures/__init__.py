...
from .api import DeparturesApiClient
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    client = DeparturesApiClient(username, password, session)

    coordinator = DeparturesDataUpdateCoordinator(hass, client=client)
