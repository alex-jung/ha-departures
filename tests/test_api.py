"""Tests for Public Transport Departures api."""
import asyncio

import aiohttp
from custom_components.ha_departures.api import (
    DeparturesApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = DeparturesApiClient("test", "test", async_get_clientsession(hass))
